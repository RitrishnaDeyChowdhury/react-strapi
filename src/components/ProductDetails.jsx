...
const ProductDetails = () => {
    ...
    const { name:product_name, price, image,category} = product;
        ...
        <section className="text-gray-600 body-font overflow-hidden">
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap mt-10 sm:mt-2">
                    <img alt="ecommerce" className="lg:w-[45%] lg:h-[500px] w-full h-64 object-contain object-center rounded" src={URL+url}/>
                    <div className="lg:w-[55%] w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex sm:flex-row flex-col">
                            <div className='flex'>
                            <span className="title-font font-medium text-2xl text-gray-900"><del className='text-[18px] text-gray-500'>${(price+200).toFixed(2)}</del> <span>${price.toFixed(2)}</span></span>
                            </div>
                            <div className='flex mt-4 sm:mt-0 justify-between'>
                            <div className="flex sm:ml-[130px] items-start sm:items-center">
